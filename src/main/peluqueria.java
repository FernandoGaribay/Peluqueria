...
public class peluqueria extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(txtAge, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 360, 40));

        jLabel5.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
        jLabel5.setText("Edad");
        jPanel3.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 350, 30));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        cliente.setAge(Integer.parseInt(this.txtAge.getText()));
